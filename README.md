Перед запуском необходимо создать файл .env с учетными данными, например:
```
POSTGRES_USER=postgres
POSTGRES_PASSWORD=postgres
```
Запустите команду ниже, чтобы сбилдить и запустить сервисы.
```sh
...
В первом доп задании написано возвращать ссылку на файл, в моей реализации возвращается сразу файл. При удалении
...
добавляться в сегменты и процент станет ниже.
